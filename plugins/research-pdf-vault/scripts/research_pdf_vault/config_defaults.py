...
SAMPLE_CONFIG_LINES: Final[tuple[str, ...]] = (
    'storage_roots = ["storage-roots/synthetic-library"]',
    'cache_root = "cache/research-pdf-vault"',
    'manifest_db = "cache/research-pdf-vault/manifest.sqlite3"',
    'ocr_engine = "none"',
